// Darkmode vor Paint aktivieren (falls include.js das nicht schon global macht)
(function(){
  try {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  async function loadMenu(){
    ...
    try {
      ...
      document.getElementById('menu').innerHTML = `<p class="muted">Menü konnte nicht geladen werden.</p>`;
    }
  }
