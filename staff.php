...
<h1>Tresen-Board</h1>
<div id="login">
  <input id="key" placeholder="Staff-Key" type="password">
...
async function login(){
  ...
  const r = await fetch('api/staff_orders.php?login=1', {method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify({key})});
